...
function preload() {
  game.load.spritesheet('item', '/assets/simon/number-buttons.png', 160, 160);
}
...
function introTween() {
  ...
  intro = true;
  for (var i = 0; i < 6; i++) {
    game.add.tween(simon.getAt(i))
      .to({ alpha: 1 }, 500, Phaser.Easing.Linear.None, true, 0, 4, true)
      .to({ alpha: 0.25 }, 500, Phaser.Easing.Linear.None, true, 0, 4, true);
  }
}
